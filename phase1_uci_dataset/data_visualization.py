...
visualize_class_distribution(data['y_train'], data['y_test'], label_map, save_path="phase1_uci_dataset/figures")
visualize_dataset_2D(data['X_train'], data['y_train'], label_map, save_path="phase1_uci_dataset/figures")
