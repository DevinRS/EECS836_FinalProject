...
def plot_roc_curve(y_test, y_score, model_name):
    ...
    plt.savefig(f"phase1_uci_dataset/figures/roc_curve_{model_name}.png")
    plt.close()
...
def train_and_evaluate_model(model, X_train, y_train, X_test, y_test):
    ...
    plt.ylabel("True")
    plt.savefig(f"phase1_uci_dataset/figures/confusion_matrix_{model_name}.png")
    plt.clf()
...
def plot_results(accuracies, aucs):
    ...
    plt.savefig("phase1_uci_dataset/figures/model_performance_comparison.png")
